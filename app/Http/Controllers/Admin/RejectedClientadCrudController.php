 ...
 */
class RejectedClientadCrudController extends CrudController
{
...
//    use \Backpack\CRUD\app\Http\Controllers\Operations\CreateOperation;
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/rejected');
        CRUD::setEntityNameStrings('إعلان', 'جميع الإعلانات');
        $this->crud->addClause('where', 'is_canceled', '1' );

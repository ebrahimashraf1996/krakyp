...
use App\Http\Middleware\IsInfoComplete;
use App\Http\Middleware\PhoneVerified;
use App\Http\Middleware\PhoneExists;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'PhoneExists' => PhoneExists::class,
        'NotEmptyCart' => NotEmptyCart::class,
        
        
        'IsInfoComplete' => IsInfoComplete::class,

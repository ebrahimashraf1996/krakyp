...
//        SluggableScopeHelpers;
    ...
    public function scopeSelection($q) {
        $q->select('id', 'title', 'description', 'slug', 'price', 'images', 'is_published', 'status','end_date', 'cat_id', 'user_id', 'country_id', 'city_id', 'state_id', 'created_at', 'is_canceled', 'reason_id', 'serial_num', 'user_package_id');
    }

                ...
                <form action="{{route('new.search.get')}}" method="get" id="new_search_form">
                    <div class="row" dir="rtl">
                        ...
                        <div class="form-group col-xxl-6 col-xl-6 col-md-6 col-6 col-sm-6 py-1" id="get_result_btn_div">
                            <button type="submit" class="btn w-100" id="get_result_btn"><i
                                    class="fa-solid fa-magnifying-glass"></i> &nbsp;اظهر النتائج
                            </button>
                        </div>
                        <div class="form-group col-xxl-6 col-xl-6 col-md-6 col-6 col-sm-6 py-1" id="get_result_btn_div">
                            <a class="btn w-100" href="javascript:void(0);" id="new_adv_search"><i
...
{{--    </section>--}}
    ...
    {{--    Start Featured Cats--}}
    <section class="featured-section special_cats text-center">
        <div class="container">
            <div class="row">

            </div>
            <div class="cats_section bordered">
                @if(isset($featured_cats) && $featured_cats->count() > 0)
                    ...
                    @foreach($featured_cats as $item)
                        ...
                        <div class="col-md-2 col-5 col-sm-5 m-auto cat_div" data-bs-target="1">
    ...
    @if(isset($posts) && $posts->count() > 0)
        <section class="blog_section container mt-5" style="">

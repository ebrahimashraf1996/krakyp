        ...
        <div class="row justify-content-center login-form">
            <div class="col-12 col-md-8 col-lg-6 login-cont mt-1 pb-5">
                ...
                <div class="card login-card">
                    <div class="card-body">
                        <form class="col-md-12 col-12 col-lg-12 col-sm-12" role="form" method="POST"
                            ...
                            <div class="form-check my-3 remember_check">
                                ...
                                <label class=" check-lable form-check-label" style="margin-right: 30px"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 col-5" style="text-align: left">
                                    @if (config('backpack.base.registration_open'))
                                        <div class=""><a class="bold" href="{{ route('backpack.auth.register') }}">مستخدم
                                                جديد ؟</a></div>
                                    @endif
                                </div>
